            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-32">
                        <div class="flex">
                            ...
                            <!-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('servers.index')" :active="route().current('servers.*')">
                                    Server
                                </JetNavLink>
                            </div> -->
                        </div>
                        ...
                        <div>
                            ...
                            <JetInput
                                type="text"
                                class="block m-2 w-60 float-right"
                                placeholder="Search"
                            />
                        </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <JetResponsiveNavLink :href="route('servers.index')" :active="route().current('servers.*')">
                            Server
